...
class Scene7Choice1ViewController: DialogViewController {
    override func viewDidLoad() {
        ...
        events = Events(events: [
            ...
            [.goToNextScene(viewController: ActViewController(title: "Day 4", subtitle: "The Act", time: "", quote: "\"Courage is fire, and bullying is smoke.\"", transitionTo: Scene8ViewController()))],
            ])
