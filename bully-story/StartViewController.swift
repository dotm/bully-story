...
//        self.present(RepetitiveViewController(), animated: true, completion: nil)
    ...
    @IBAction func startGame(_ sender: Any) {
        ...
        Timer.scheduledTimer(withTimeInterval: 15, repeats: false, block: { (_) in
            ...
            playerController.present(ActViewController(title: "Day 1", subtitle: "Introduction", quote: "\"Research indicates that persistent bullying can lead to suicidal behavior.\"", transitionTo: Scene2ViewController()), animated: false, completion: nil)
        })
